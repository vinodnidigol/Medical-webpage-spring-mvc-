...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
   ...
   <div class="row">
   <div class="col-md-6">
   <a class="promo-title"> <i href="#" class="fa fa-stethoscope" aria-hidden="true"></i>BEST DOCTOR </a>
    <P>Preventive health checkup by expert doctors 
       to take complete control of health</P>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<c:url value="/image/s1.jpg"  />" class="d-block w-100" alt="hul company">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="/image/s1.jpg"  />" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="/image/s1.jpg"  />" class="d-block w-100" alt="...">
    </div>
